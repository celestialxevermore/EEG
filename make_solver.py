...
def make_solver(args, net, train_loader, val_loader, test_loader):
    print("[Make solver]")
    # Set criterion
    ...
    solver = module.Solver(args, net, train_loader, val_loader, test_loader, criterion, optimizer, scheduler, log_dict)
    print("")
    return solver
...
def set_metrics(args):
    if args.train_cont_path:
        ...
        log_dict = {f"{phase}_{metric}": [] for phase in ["train", "val", "test"] for metric in args.metrics}
    return log_dict
